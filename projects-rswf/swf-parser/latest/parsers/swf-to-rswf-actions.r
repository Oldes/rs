rebol [title: "SWF-to-RSWF tag Actions"]

swfTagToRSWFActions: make hash! [
		0  ["end"]
		1  ["showFrame"]
	2  [
		convert-DefineShape
		;probe parse-defineShape
	]
	4  [parse-PlaceObject]
