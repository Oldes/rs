; JIS_C6220-1969-JP UCS-2 encoding rule
; source:  ftp://dkuug.dk/i18n/charmaps/JIS_C6220-1969-JP
any [
#{21} (insert tail result #{3002}) | 
#{22} (insert tail result #{300C}) | 
#{23} (insert tail result #{300D}) | 
#{24} (insert tail result #{3001}) | 
#{25} (insert tail result #{30FB}) | 
#{26} (insert tail result #{30F2}) | 
#{27} (insert tail result #{30A1}) | 
#{28} (insert tail result #{30A3}) | 
#{29} (insert tail result #{30A5}) | 
#{2A} (insert tail result #{30A7}) | 
#{2B} (insert tail result #{30A9}) | 
#{2C} (insert tail result #{30E3}) | 
#{2D} (insert tail result #{30E5}) | 
#{2E} (insert tail result #{30E7}) | 
#{2F} (insert tail result #{30C3}) | 
