...
#{005B} (insert tail result #{AD}) | 
#{00DE} (insert tail result #{AE}) | 
#{00AE} (insert tail result #{AF}) | 
#{00AC} (insert tail result #{B0}) | 
...
#{00DD} (insert tail result #{BA}) | 
#{00A8} (insert tail result #{BB}) | 
#{00AF} (insert tail result #{BC}) | 
#{005D} (insert tail result #{BD}) | 
