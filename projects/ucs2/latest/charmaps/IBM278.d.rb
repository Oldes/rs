...
#{00A4} (insert tail result #{5A}) | 
#{00C5} (insert tail result #{5B}) | 
...
#{00E9} (insert tail result #{79}) | 
#{003A} (insert tail result #{7A}) | 
#{00C4} (insert tail result #{7B}) | 
...
#{005D} (insert tail result #{9F}) | 
#{00B5} (insert tail result #{A0}) | 
#{00FC} (insert tail result #{A1}) | 
