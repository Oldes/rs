...
#{007D} (insert tail result #{8C}) | 
#{0060} (insert tail result #{8D}) | 
#{00A6} (insert tail result #{8E}) | 
...
#{005D} (insert tail result #{AC}) | 
#{0024} (insert tail result #{AD}) | 
#{0040} (insert tail result #{AE}) | 
