...
#{0024} (insert tail result #{5A}) | 
#{00C7} (insert tail result #{5B}) | 
...
#{00E3} (insert tail result #{79}) | 
#{003A} (insert tail result #{7A}) | 
#{00D5} (insert tail result #{7B}) | 
#{00C3} (insert tail result #{7C}) | 
