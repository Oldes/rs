...
#{060C} (insert tail result #{42}) | 
#{061B} (insert tail result #{43}) | 
#{061F} (insert tail result #{44}) | 
#{0623} (insert tail result #{45}) | 
#{0627} (insert tail result #{46}) | 
#{FE8E} (insert tail result #{47}) | 
#{0628} (insert tail result #{49}) | 
...
#{FE91} (insert tail result #{51}) | 
#{067E} (insert tail result #{52}) | 
#{0629} (insert tail result #{54}) | 
#{062A} (insert tail result #{55}) | 
#{FE97} (insert tail result #{56}) | 
#{062B} (insert tail result #{59}) | 
...
#{FE9B} (insert tail result #{62}) | 
#{062C} (insert tail result #{63}) | 
#{FE9F} (insert tail result #{64}) | 
#{062D} (insert tail result #{67}) | 
#{FEA3} (insert tail result #{68}) | 
#{062E} (insert tail result #{69}) | 
#{0060} (insert tail result #{6A}) | 
...
#{0660} (insert tail result #{70}) | 
#{0661} (insert tail result #{71}) | 
#{0662} (insert tail result #{72}) | 
#{0663} (insert tail result #{73}) | 
#{0664} (insert tail result #{74}) | 
#{0665} (insert tail result #{75}) | 
#{0666} (insert tail result #{76}) | 
#{0667} (insert tail result #{77}) | 
#{0668} (insert tail result #{78}) | 
#{0669} (insert tail result #{79}) | 
...
#{062F} (insert tail result #{8A}) | 
#{0630} (insert tail result #{8C}) | 
#{0631} (insert tail result #{8D}) | 
#{0632} (insert tail result #{8F}) | 
...
#{0633} (insert tail result #{9A}) | 
#{FEB3} (insert tail result #{9B}) | 
#{0634} (insert tail result #{9C}) | 
#{FEB7} (insert tail result #{9D}) | 
#{0635} (insert tail result #{9E}) | 
#{FEBB} (insert tail result #{9F}) | 
#{0636} (insert tail result #{A0}) | 
...
#{FEBF} (insert tail result #{AA}) | 
#{0637} (insert tail result #{AB}) | 
#{0638} (insert tail result #{AC}) | 
#{0639} (insert tail result #{AD}) | 
#{FECA} (insert tail result #{AE}) | 
#{FECB} (insert tail result #{AF}) | 
#{FECC} (insert tail result #{B0}) | 
#{063A} (insert tail result #{B1}) | 
#{FECE} (insert tail result #{B2}) | 
#{FECF} (insert tail result #{B3}) | 
#{FED0} (insert tail result #{B4}) | 
#{0641} (insert tail result #{B5}) | 
#{FED3} (insert tail result #{B6}) | 
#{0642} (insert tail result #{B7}) | 
#{FED7} (insert tail result #{B8}) | 
#{0643} (insert tail result #{B9}) | 
#{FEDB} (insert tail result #{BA}) | 
#{007C} (insert tail result #{BB}) | 
#{0644} (insert tail result #{BE}) | 
#{FEDE} (insert tail result #{BF}) | 
...
#{0645} (insert tail result #{CC}) | 
#{FEE3} (insert tail result #{CD}) | 
#{0646} (insert tail result #{CF}) | 
...
#{FEE7} (insert tail result #{DA}) | 
#{0648} (insert tail result #{DC}) | 
