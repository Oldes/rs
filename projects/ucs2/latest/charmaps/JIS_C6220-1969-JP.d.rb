; JIS_C6220-1969-JP UCS-2 decoding rule
;  source: ftp://dkuug.dk/i18n/charmaps/JIS_C6220-1969-JP
any [
#{3002} (insert tail result #{21}) | 
#{300C} (insert tail result #{22}) | 
#{300D} (insert tail result #{23}) | 
#{3001} (insert tail result #{24}) | 
#{30FB} (insert tail result #{25}) | 
#{30F2} (insert tail result #{26}) | 
#{30A1} (insert tail result #{27}) | 
#{30A3} (insert tail result #{28}) | 
#{30A5} (insert tail result #{29}) | 
#{30A7} (insert tail result #{2A}) | 
#{30A9} (insert tail result #{2B}) | 
#{30E3} (insert tail result #{2C}) | 
#{30E5} (insert tail result #{2D}) | 
#{30E7} (insert tail result #{2E}) | 
#{30C3} (insert tail result #{2F}) | 
