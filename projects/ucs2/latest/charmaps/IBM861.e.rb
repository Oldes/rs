...
#{8B} (insert tail result #{00D0}) | 
#{8C} (insert tail result #{00F0}) | 
#{8D} (insert tail result #{00DE}) | 
...
#{95} (insert tail result #{00FE}) | 
#{96} (insert tail result #{00FB}) | 
#{97} (insert tail result #{00DD}) | 
#{98} (insert tail result #{00FD}) | 
...
#{A4} (insert tail result #{00C1}) | 
#{A5} (insert tail result #{00CD}) | 
#{A6} (insert tail result #{00D3}) | 
#{A7} (insert tail result #{00DA}) | 
