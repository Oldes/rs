; IBM860 UCS-2 decoding rule
;  source: ftp://dkuug.dk/i18n/charmaps/IBM860
any [
#{00C7} (insert tail result #{80}) | 
#{00FC} (insert tail result #{81}) | 
#{00E9} (insert tail result #{82}) | 
#{00E2} (insert tail result #{83}) | 
#{00E3} (insert tail result #{84}) | 
#{00E0} (insert tail result #{85}) | 
#{00C1} (insert tail result #{86}) | 
#{00E7} (insert tail result #{87}) | 
#{00EA} (insert tail result #{88}) | 
#{00CA} (insert tail result #{89}) | 
#{00E8} (insert tail result #{8A}) | 
#{00CE} (insert tail result #{8B}) | 
#{00D4} (insert tail result #{8C}) | 
#{00EC} (insert tail result #{8D}) | 
#{00C3} (insert tail result #{8E}) | 
#{00C2} (insert tail result #{8F}) | 
#{00C9} (insert tail result #{90}) | 
#{00C0} (insert tail result #{91}) | 
#{00C8} (insert tail result #{92}) | 
#{00F4} (insert tail result #{93}) | 
#{00F5} (insert tail result #{94}) | 
#{00F2} (insert tail result #{95}) | 
#{00DA} (insert tail result #{96}) | 
#{00F9} (insert tail result #{97}) | 
#{00CC} (insert tail result #{98}) | 
#{00D5} (insert tail result #{99}) | 
