...
#{0452} (insert tail result #{42}) | 
#{0453} (insert tail result #{43}) | 
#{0451} (insert tail result #{44}) | 
#{0455} (insert tail result #{46}) | 
#{0456} (insert tail result #{47}) | 
#{0457} (insert tail result #{48}) | 
#{0458} (insert tail result #{49}) | 
...
#{0459} (insert tail result #{51}) | 
#{045A} (insert tail result #{52}) | 
#{045B} (insert tail result #{53}) | 
#{045C} (insert tail result #{54}) | 
#{045F} (insert tail result #{56}) | 
#{042A} (insert tail result #{57}) | 
#{2116} (insert tail result #{58}) | 
#{0402} (insert tail result #{59}) | 
...
#{040A} (insert tail result #{70}) | 
#{040B} (insert tail result #{71}) | 
#{040C} (insert tail result #{72}) | 
#{040F} (insert tail result #{75}) | 
#{044E} (insert tail result #{76}) | 
#{0430} (insert tail result #{77}) | 
#{0431} (insert tail result #{78}) | 
...
#{0434} (insert tail result #{8A}) | 
#{0435} (insert tail result #{8B}) | 
#{0444} (insert tail result #{8C}) | 
#{0433} (insert tail result #{8D}) | 
#{0445} (insert tail result #{8E}) | 
#{0438} (insert tail result #{8F}) | 
#{0439} (insert tail result #{90}) | 
...
#{043A} (insert tail result #{9A}) | 
#{043B} (insert tail result #{9B}) | 
#{043C} (insert tail result #{9C}) | 
#{043D} (insert tail result #{9D}) | 
#{043E} (insert tail result #{9E}) | 
#{043F} (insert tail result #{9F}) | 
#{044F} (insert tail result #{A0}) | 
...
#{0440} (insert tail result #{AA}) | 
#{0441} (insert tail result #{AB}) | 
#{0442} (insert tail result #{AC}) | 
#{0443} (insert tail result #{AD}) | 
#{0436} (insert tail result #{AE}) | 
#{0432} (insert tail result #{AF}) | 
#{044C} (insert tail result #{B0}) | 
#{044B} (insert tail result #{B1}) | 
#{0437} (insert tail result #{B2}) | 
#{0448} (insert tail result #{B3}) | 
#{044D} (insert tail result #{B4}) | 
#{0449} (insert tail result #{B5}) | 
#{0447} (insert tail result #{B6}) | 
#{044A} (insert tail result #{B7}) | 
#{042E} (insert tail result #{B8}) | 
#{0410} (insert tail result #{B9}) | 
#{0411} (insert tail result #{BA}) | 
#{0426} (insert tail result #{BB}) | 
#{0414} (insert tail result #{BC}) | 
#{0415} (insert tail result #{BD}) | 
#{0424} (insert tail result #{BE}) | 
#{0413} (insert tail result #{BF}) | 
...
#{0425} (insert tail result #{CA}) | 
#{0418} (insert tail result #{CB}) | 
#{0419} (insert tail result #{CC}) | 
#{041A} (insert tail result #{CD}) | 
#{041B} (insert tail result #{CE}) | 
#{041C} (insert tail result #{CF}) | 
...
#{041D} (insert tail result #{DA}) | 
#{041E} (insert tail result #{DB}) | 
#{041F} (insert tail result #{DC}) | 
#{042F} (insert tail result #{DD}) | 
#{0420} (insert tail result #{DE}) | 
#{0421} (insert tail result #{DF}) | 
#{005C} (insert tail result #{E0}) | 
#{00A4} (insert tail result #{E1}) | 
...
#{0422} (insert tail result #{EA}) | 
#{0423} (insert tail result #{EB}) | 
#{0416} (insert tail result #{EC}) | 
#{0412} (insert tail result #{ED}) | 
#{042C} (insert tail result #{EE}) | 
#{042B} (insert tail result #{EF}) | 
