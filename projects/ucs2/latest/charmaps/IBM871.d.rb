...
#{0060} (insert tail result #{8C}) | 
#{00FD} (insert tail result #{8D}) | 
#{007B} (insert tail result #{8E}) | 
...
#{007D} (insert tail result #{9C}) | 
#{00B8} (insert tail result #{9D}) | 
#{005D} (insert tail result #{9E}) | 
...
#{0040} (insert tail result #{AC}) | 
#{00DD} (insert tail result #{AD}) | 
#{005B} (insert tail result #{AE}) | 
...
#{005C} (insert tail result #{BE}) | 
#{00D7} (insert tail result #{BF}) | 
#{00DE} (insert tail result #{C0}) | 
