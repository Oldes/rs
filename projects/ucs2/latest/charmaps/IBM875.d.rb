...
#{03AA} (insert tail result #{68}) | 
#{03AB} (insert tail result #{69}) | 
...
#{03CA} (insert tail result #{CC}) | 
#{03CB} (insert tail result #{CD}) | 
#{2018} (insert tail result #{CE}) | 
#{2015} (insert tail result #{CF}) | 
...
#{00BD} (insert tail result #{DB}) | 
#{00B7} (insert tail result #{DD}) | 
#{2019} (insert tail result #{DE}) | 
...
#{00A7} (insert tail result #{EB}) | 
#{00AB} (insert tail result #{EE}) | 
#{00AC} (insert tail result #{EF}) | 
...
#{00A9} (insert tail result #{FB}) | 
#{00BB} (insert tail result #{FE}) | 
