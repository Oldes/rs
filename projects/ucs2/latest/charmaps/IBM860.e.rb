...
#{84} (insert tail result #{00E3}) | 
#{85} (insert tail result #{00E0}) | 
#{86} (insert tail result #{00C1}) | 
#{87} (insert tail result #{00E7}) | 
#{88} (insert tail result #{00EA}) | 
#{89} (insert tail result #{00CA}) | 
#{8A} (insert tail result #{00E8}) | 
#{8B} (insert tail result #{00CE}) | 
#{8C} (insert tail result #{00D4}) | 
#{8D} (insert tail result #{00EC}) | 
#{8E} (insert tail result #{00C3}) | 
#{8F} (insert tail result #{00C2}) | 
#{90} (insert tail result #{00C9}) | 
#{91} (insert tail result #{00C0}) | 
#{92} (insert tail result #{00C8}) | 
#{93} (insert tail result #{00F4}) | 
#{94} (insert tail result #{00F5}) | 
#{95} (insert tail result #{00F2}) | 
#{96} (insert tail result #{00DA}) | 
#{97} (insert tail result #{00F9}) | 
#{98} (insert tail result #{00CC}) | 
#{99} (insert tail result #{00D5}) | 
