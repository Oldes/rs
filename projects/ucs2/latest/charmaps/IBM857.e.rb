...
#{9E} (insert tail result #{015E}) | 
#{9F} (insert tail result #{015F}) | 
...
#{A6} (insert tail result #{011E}) | 
#{A7} (insert tail result #{011F}) | 
...
#{D0} (insert tail result #{00BA}) | 
#{D1} (insert tail result #{00AA}) | 
...
#{E8} (insert tail result #{00D7}) | 
#{E9} (insert tail result #{00DA}) | 
#{EA} (insert tail result #{00DB}) | 
#{EB} (insert tail result #{00D9}) | 
#{ED} (insert tail result #{00FF}) | 
#{EE} (insert tail result #{2014}) | 
