...
#{84} (insert tail result #{00C2}) | 
#{85} (insert tail result #{00E0}) | 
#{86} (insert tail result #{00B6}) | 
...
#{8E} (insert tail result #{00C0}) | 
#{8F} (insert tail result #{00A7}) | 
#{90} (insert tail result #{00C9}) | 
#{91} (insert tail result #{00C8}) | 
#{92} (insert tail result #{00CA}) | 
#{93} (insert tail result #{00F4}) | 
#{94} (insert tail result #{00CB}) | 
#{95} (insert tail result #{00CF}) | 
#{96} (insert tail result #{00FB}) | 
#{97} (insert tail result #{00F9}) | 
#{98} (insert tail result #{00A4}) | 
#{99} (insert tail result #{00D4}) | 
#{9A} (insert tail result #{00DC}) | 
#{9B} (insert tail result #{00A2}) | 
#{9C} (insert tail result #{00A3}) | 
#{9D} (insert tail result #{00D9}) | 
#{9E} (insert tail result #{00DB}) | 
#{9F} (insert tail result #{0192}) | 
#{A0} (insert tail result #{00A6}) | 
#{A1} (insert tail result #{00B4}) | 
#{A2} (insert tail result #{00F3}) | 
#{A3} (insert tail result #{00FA}) | 
#{A4} (insert tail result #{00A8}) | 
#{A5} (insert tail result #{00B8}) | 
#{A6} (insert tail result #{00B3}) | 
#{A7} (insert tail result #{00AF}) | 
#{A8} (insert tail result #{00CE}) | 
#{A9} (insert tail result #{2310}) | 
#{AA} (insert tail result #{00AC}) | 
#{AB} (insert tail result #{00BD}) | 
#{AC} (insert tail result #{00BC}) | 
#{AD} (insert tail result #{00BE}) | 
