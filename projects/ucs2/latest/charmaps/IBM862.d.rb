; IBM862 UCS-2 decoding rule
;  source: ftp://dkuug.dk/i18n/charmaps/IBM862
any [
#{05D0} (insert tail result #{80}) | 
#{05D1} (insert tail result #{81}) | 
#{05D2} (insert tail result #{82}) | 
#{05D3} (insert tail result #{83}) | 
#{05D4} (insert tail result #{84}) | 
#{05D5} (insert tail result #{85}) | 
#{05D6} (insert tail result #{86}) | 
#{05D7} (insert tail result #{87}) | 
#{05D8} (insert tail result #{88}) | 
#{05D9} (insert tail result #{89}) | 
#{05DA} (insert tail result #{8A}) | 
#{05DB} (insert tail result #{8B}) | 
#{05DC} (insert tail result #{8C}) | 
#{05DD} (insert tail result #{8D}) | 
#{05DE} (insert tail result #{8E}) | 
#{05DF} (insert tail result #{8F}) | 
#{05E0} (insert tail result #{90}) | 
#{05E1} (insert tail result #{91}) | 
#{05E2} (insert tail result #{92}) | 
#{05E3} (insert tail result #{93}) | 
#{05E4} (insert tail result #{94}) | 
#{05E5} (insert tail result #{95}) | 
#{05E6} (insert tail result #{96}) | 
#{05E7} (insert tail result #{97}) | 
#{05E8} (insert tail result #{98}) | 
#{05E9} (insert tail result #{99}) | 
#{05EA} (insert tail result #{9A}) | 
