...
#{0040} (insert tail result #{44}) | 
#{00E1} (insert tail result #{45}) | 
#{00E3} (insert tail result #{46}) | 
#{00E5} (insert tail result #{47}) | 
#{005C} (insert tail result #{48}) | 
#{00F1} (insert tail result #{49}) | 
#{00B0} (insert tail result #{4A}) | 
...
#{007B} (insert tail result #{51}) | 
#{00EA} (insert tail result #{52}) | 
#{00EB} (insert tail result #{53}) | 
#{007D} (insert tail result #{54}) | 
...
#{00C3} (insert tail result #{66}) | 
#{00C5} (insert tail result #{67}) | 
#{00C7} (insert tail result #{68}) | 
#{00D1} (insert tail result #{69}) | 
#{00F9} (insert tail result #{6A}) | 
...
#{00AB} (insert tail result #{8A}) | 
#{00BB} (insert tail result #{8B}) | 
#{00F0} (insert tail result #{8C}) | 
#{00FD} (insert tail result #{8D}) | 
#{00FE} (insert tail result #{8E}) | 
#{00B1} (insert tail result #{8F}) | 
#{005B} (insert tail result #{90}) | 
...
#{00AA} (insert tail result #{9A}) | 
#{00BA} (insert tail result #{9B}) | 
#{00E6} (insert tail result #{9C}) | 
#{00B8} (insert tail result #{9D}) | 
#{00C6} (insert tail result #{9E}) | 
#{00A4} (insert tail result #{9F}) | 
#{0060} (insert tail result #{A0}) | 
...
#{00A1} (insert tail result #{AA}) | 
#{00BF} (insert tail result #{AB}) | 
#{00D0} (insert tail result #{AC}) | 
#{00DD} (insert tail result #{AD}) | 
#{00DE} (insert tail result #{AE}) | 
#{00AE} (insert tail result #{AF}) | 
#{00A2} (insert tail result #{B0}) | 
#{0023} (insert tail result #{B1}) | 
#{00A5} (insert tail result #{B2}) | 
#{00B7} (insert tail result #{B3}) | 
#{00A9} (insert tail result #{B4}) | 
#{005D} (insert tail result #{B5}) | 
#{00BC} (insert tail result #{B7}) | 
#{00BD} (insert tail result #{B8}) | 
#{00BE} (insert tail result #{B9}) | 
#{00AC} (insert tail result #{BA}) | 
#{007C} (insert tail result #{BB}) | 
#{203E} (insert tail result #{BC}) | 
#{007E} (insert tail result #{BD}) | 
#{00B4} (insert tail result #{BE}) | 
#{00D7} (insert tail result #{BF}) | 
#{00E9} (insert tail result #{C0}) | 
...
#{00F5} (insert tail result #{CF}) | 
#{00E8} (insert tail result #{D0}) | 
