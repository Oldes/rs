REBOL [
    Title: "Console-port"
    Date: 17-Jun-2003/16:57:38+2:00
    Name: none
    Version: 0.1.0
    File: none
    Home: none
...
set 'ctx-console make object! [
	...
	print-line: func[][s-prin rejoin [prompt head buffer "^(1B)[" length? buffer "D"]]
	s-print: get in system/words 'print
	s-prin:  get in system/words 'prin
	clear-line: func[][
