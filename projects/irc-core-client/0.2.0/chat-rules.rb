rebol [
	...
	[][thru "kolik je hodin" to end][reply rejoin ["Ja mam ted: " now/time]]
	...
	[]["Top10(words): 1. " copy tmp to {(} to end][say rejoin ["ten " tmp " je ale ukecanej!"]]
	[][thru {pozpatku "} copy tmp to {"} to end][say rejoin [{"} head reverse tmp {"}]]
